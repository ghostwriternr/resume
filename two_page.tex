...
\textsc{Current} & \textbf{Co-founder \& CTO}\hfill\raisebox{.2\height}{\includegraphics[height=1.3em,valign=c]{logos/codestory.png}\includegraphics[height=1.2em,valign=c]{logos/yc.png}\hspace{0.5em}}\textbf{CodeStory (YC S23)}\\
\textsc{Jul '23} & \begin{itemize}[leftmargin=*, nosep, before=\vspace{-0.8\baselineskip}, after=\vspace{-1.0\baselineskip}]
  \item Working on an AI-first code editor, Aide by CodeStory, forked from the Open Source VSCode project by Microsoft.
  \item Built an editor-native AI agent atop GPT-3.5 \& 4, capable of gathering codebase-wide context and making multi-step, multi-file edits using local embeddings and code graphs indexed and stored with Qdrant and SQLite.
  \item Setup CI pipelines on GitHub \& CircleCI to build and notarize the editor for all operating systems \& architectures.
  \item Shipped the first version in 2 weeks during the YCombinator S23 batch and raised \$1.4M in pre-seed funding.
\end{itemize}\\
\multicolumn{2}{c}{} \\
